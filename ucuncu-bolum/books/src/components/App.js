...
class App extends React.Component {
  /*state = {
    books: [ 
      //props yöntemi için burda tuttuğumuz verileri context yöntemi için buradan alıp BookContext in içine yazdık bu yüzden artık burada stati kullanmaya gerek kalmadı
      {
  ...
  render() {
    return (
        <div>
            ...
            {/* <BookList books={this.state.books}></BookList> Artık state ihtiyacımız olmadığı için props u da sildik */}
            {/* statette olan veriyi props yardımı ile(book) booklist komponentine gönderiyoruz */}
            </React.StrictMode>
        </div>
    )
  }
...
// App komponentine kitaplar statte
// BookList komponentine kitaplar propsta
// Book komponentinde kitapların her biri ayrı keyler ile kendi içersinde 
