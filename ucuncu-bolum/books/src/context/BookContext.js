...
// 1. YÖNTEM İÇİN CONTEXTİ BU ŞEKİLDE KULLANIRIZ

/*export default React.createContext(
    //iletmek istediğimiz veriyi BookContext üzerinden ileteceğiz
    [
        {
...
class BookContextProvider extends React.Component{
    ...
    render(){
        return(
            // burada veriyi provider ile gönderiyoruz
            <BookContext.Provider value={{...this.state}}>
                {/* myData nın içindeki veriyi this.state ile aldık */}
                {this.props.children}
...
//veri başlangıç değeri olarak değil class componentte state olarak tutuluyor
